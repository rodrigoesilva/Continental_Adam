...
namespace Continental.Project.Adam.UI.Models.COM
{
    ...
    {
        public static double _rPressaoCS_Bar;
        public static double _rPressaoCP_Bar;
        public static double _rPressaoBubbleTest_Bar;
        public static double _rPressaoHidraulica_Bar;
        public static double _rVacuo_Bar;
        public static double _rDeslocamentoDiferencial_mm;
        public static double _rDeslocamentoEntradaBooster_mm;
        public static double _rDeslocamentoSaidaBooster_mm;
        public static double _rForcaEntradaBooster_N;
        public static double _rForcaSaidaBooster_N;
        public static double _rTemperaturaAmbiente_C;
        public static double _rUmidadeRelativa;


        public static double rPressaoCS_Bar
        {

            get { return GVL_Analogicas._rPressaoCS_Bar; }
            set { GVL_Analogicas._rPressaoCS_Bar = value; }
        }
        public static double rPressaoCP_Bar
        {
            get { return GVL_Analogicas._rPressaoCP_Bar; }
            set { GVL_Analogicas._rPressaoCP_Bar = value; }
        }
        public static double rPressaoBubbleTest_Bar
        {
            get { return GVL_Analogicas._rPressaoBubbleTest_Bar; }
            set { GVL_Analogicas._rPressaoBubbleTest_Bar = value; }
        }
        public static double rPressaoHidraulica_Bar
        {
            get { return GVL_Analogicas._rPressaoHidraulica_Bar; }
            set { GVL_Analogicas._rPressaoHidraulica_Bar = value; }
        }
        public static double rVacuo_Bar
        {
            get { return GVL_Analogicas._rVacuo_Bar; }
            set { GVL_Analogicas._rVacuo_Bar = value; }
        }
        public static double rDeslocamentoDiferencial_mm
        {
            get { return GVL_Analogicas._rDeslocamentoDiferencial_mm; }
            set { GVL_Analogicas._rDeslocamentoDiferencial_mm = value; }
        }
        public static double rDeslocamentoEntradaBooster_mm
        {
            get { return GVL_Analogicas._rDeslocamentoEntradaBooster_mm; }
            set { GVL_Analogicas._rDeslocamentoEntradaBooster_mm = value; }
        }
        public static double rDeslocamentoSaidaBooster_mm
        {
            get { return GVL_Analogicas._rDeslocamentoSaidaBooster_mm; }
            set { GVL_Analogicas._rDeslocamentoSaidaBooster_mm = value; }
        }
        public static double rForcaEntradaBooster_N
        {
            get { return GVL_Analogicas._rForcaEntradaBooster_N; }
            set { GVL_Analogicas._rForcaEntradaBooster_N = value; }
        }
        public static double rForcaSaidaBooster_N
        {
            get { return GVL_Analogicas._rForcaSaidaBooster_N; }
            set { GVL_Analogicas._rForcaSaidaBooster_N = value; }
        }
        public static double rTemperaturaAmbiente_C
        {
            get { return GVL_Analogicas._rTemperaturaAmbiente_C; }
            set { GVL_Analogicas._rTemperaturaAmbiente_C = value; }
        }
        public static double rUmidadeRelativa
        {
            get { return GVL_Analogicas._rUmidadeRelativa; }
            set { GVL_Analogicas._rUmidadeRelativa = value; }
        }
    }
    ...
    public class GVL_T01
    {
        ...
        //Resultados do teste
        private static double _rVacuoInicial; //  ;REAL;
        private static double _rTemperaturaInicial; //  ;REAL;
        public static double rVacuoInicial
        {
            get { return GVL_T01._rVacuoInicial; }
            set { GVL_T01._rVacuoInicial = value; }
        }
        public static double rTemperaturaInicial
        {
            get { return GVL_T01._rTemperaturaInicial; }
            set { GVL_T01._rTemperaturaInicial = value; }
        }
    ...
    public class GVL_T02
    {
        ...
        public static double rVacuoInicial
        {
            get { return GVL_T02._rVacuoInicial; }
            set { GVL_T02._rVacuoInicial = value; }
        }
        public static double rTemperaturaInicial
        {
            get { return GVL_T02._rTemperaturaInicial; }
            set { GVL_T02._rTemperaturaInicial = value; }
        }
        public int iConsumidoresCP;// : INT;
        public int iConsumidoresCS;// : INT;
        public long diPosicaoForcaMaxima;// : DINT; //indice do array que indica o pico de forca, tambem indica que o gráfico começou a "voltar" a partir daqui
    ...
    public class GVL_T03
    {
        ...
        public static double rVacuoInicial
        {
            get { return GVL_T03._rVacuoInicial; }
            set { GVL_T03._rVacuoInicial = value; }
        }
        public static double rTemperaturaInicial
        {
            get { return GVL_T03._rTemperaturaInicial; }
            set { GVL_T03._rTemperaturaInicial = value; }
        }
        public int iConsumidoresCP;// : INT;
        public int iConsumidoresCS;// : INT;
        public long diPosicaoForcaMaxima;// : DINT; //indice do array que indica o pico de forca, tambem indica que o gráfico começou a "voltar" a partir daqui
    ...
    public class GVL_T04
    {
        ...
        public static double rVacuoInicial
        {
            get { return GVL_T04._rVacuoInicial; }
            set { GVL_T04._rVacuoInicial = value; }
        }
        public static double rTemperaturaInicial
        {
            get { return GVL_T04._rTemperaturaInicial; }
            set { GVL_T04._rTemperaturaInicial = value; }
        }
        public long diPosicaoForcaMaxima;// : DINT; //indice do array que indica o pico de forca, tambem indica que o gráfico começou a "voltar" a partir daqui
        public double rForcaMaxima;// : REAL;
        public double rDeslocamentoMaximo;// : REAL;
    ...
    public class GVL_T05
    {
        ...
        public static double rVacuoInicial
        {
            get { return GVL_T05._rVacuoInicial; }
            set { GVL_T05._rVacuoInicial = value; }
        }
        public static double rTemperaturaInicial
        {
            get { return GVL_T05._rTemperaturaInicial; }
            set { GVL_T05._rTemperaturaInicial = value; }
        }
        public double rTempoInicial;// : REAL;
        private static double _rVacuoFinal;// : REAL;
        public static double rVacuoFinal
        {
            get { return GVL_T05._rVacuoFinal; }
            set { GVL_T05._rVacuoFinal = value; }
        }
    ...
    public class GVL_T06
    {
        ...
        public static double rVacuoInicial
        {
            get { return GVL_T06._rVacuoInicial; }
            set { GVL_T06._rVacuoInicial = value; }
        }
        public static double rTemperaturaInicial
        {
            get { return GVL_T06._rTemperaturaInicial; }
            set { GVL_T06._rTemperaturaInicial = value; }
        }
        public double rTempoInicial;// : REAL;
        private static double _rVacuoFinal;// : REAL;
        public static double rVacuoFinal
        {
            get { return GVL_T06._rVacuoFinal; }
            set { GVL_T06._rVacuoFinal = value; }
        }
        public double rTempoFinal;// : REAL;
        public int iConsumidoresCP;// : INT;
        public int iConsumidoresCS;// : INT;
    ...
    public class GVL_T07
    {
        ...
        public static double rVacuoInicial
        {
            get { return GVL_T07._rVacuoInicial; }
            set { GVL_T07._rVacuoInicial = value; }
        }
        public static double rTemperaturaInicial
        {
            get { return GVL_T07._rTemperaturaInicial; }
            set { GVL_T07._rTemperaturaInicial = value; }
        }
        public double rTempoInicial;// : REAL;
        private static double _rVacuoFinal;// : REAL;
        public static double rVacuoFinal
        {
            get { return GVL_T07._rVacuoFinal; }
            set { GVL_T07._rVacuoFinal = value; }
        }
        public double rTempoFinal;// : REAL;
        public int iConsumidoresCP;// : INT;
        public int iConsumidoresCS;// : INT;
    ...
    public class GVL_T08
    {
        ...
        public static double rVacuoInicial
        {
            get { return GVL_T08._rVacuoInicial; }
            set { GVL_T08._rVacuoInicial = value; }
        }
        public static double rTemperaturaInicial
        {
            get { return GVL_T08._rTemperaturaInicial; }
            set { GVL_T08._rTemperaturaInicial = value; }
        }
        private static double _rVacuoFinal;// : REAL;
        public static double rVacuoFinal
        {
            get { return GVL_T08._rVacuoFinal; }
            set { GVL_T08._rVacuoFinal = value; }
        }
        public double rForcaMaxima;// : REAL;
        public double rDeslocamentoEmFMax;// : REAL;
        public double rPerdaVacuo;// : REAL;
        private static double _rPressaoInicialCP;// : REAL;
        private static double _rPressaoFinalCP;// : REAL;
        public double rPerdaPressaoCP;// : REAL;
        public static double rPressaoInicialCP
        {
            get { return GVL_T08._rPressaoInicialCP; }
            set { GVL_T08._rPressaoInicialCP = value; }
        }
        public static double rPressaoFinalCP
        {
            get { return GVL_T08._rPressaoFinalCP; }
            set { GVL_T08._rPressaoFinalCP = value; }
        }
        private static double _rPressaoInicialCS;// : REAL;
        private static double _rPressaoFinalCS;// : REAL;
        public double rPerdaPressaoCS;// : REAL;
        public static double rPressaoInicialCS
        {
            get { return GVL_T08._rPressaoInicialCS; }
            set { GVL_T08._rPressaoInicialCS = value; }
        }
        public static double rPressaoFinalCS
        {
            get { return GVL_T08._rPressaoFinalCS; }
            set { GVL_T08._rPressaoFinalCS = value; }
        }
    }
    public class GVL_T09
    {
        ...
        public static double rVacuoInicial
        {
            get { return GVL_T09._rVacuoInicial; }
            set { GVL_T09._rVacuoInicial = value; }
        }
        public static double rTemperaturaInicial
        {
            get { return GVL_T09._rTemperaturaInicial; }
            set { GVL_T09._rTemperaturaInicial = value; }
        }
        private static double _rVacuoFinal;// : REAL;
        public static double rVacuoFinal
        {
            get { return GVL_T09._rVacuoFinal; }
            set { GVL_T09._rVacuoFinal = value; }
        }
        public double rForcaMaxima;// : REAL;
        ...
        public static double rPressaoInicialCP
        {
            get { return GVL_T09._rPressaoInicialCP; }
            set { GVL_T09._rPressaoInicialCP = value; }
        }
        public static double rPressaoFinalCP
        {
            get { return GVL_T09._rPressaoFinalCP; }
            set { GVL_T09._rPressaoFinalCP = value; }
        }
        private static double _rPressaoInicialCS;// : REAL;
        private static double _rPressaoFinalCS;// : REAL;
        public double rPerdaPressaoCS;// : REAL;
        public static double rPressaoInicialCS
        {
            get { return GVL_T09._rPressaoInicialCS; }
            set { GVL_T09._rPressaoInicialCS = value; }
        }
        public static double rPressaoFinalCS
        {
            get { return GVL_T09._rPressaoFinalCS; }
            set { GVL_T09._rPressaoFinalCS = value; }
        }
    }
    public class GVL_T10
    {
        ...
        public static double rVacuoInicial
        {
            get { return GVL_T10._rVacuoInicial; }
            set { GVL_T10._rVacuoInicial = value; }
        }
        public static double rTemperaturaInicial
        {
            get { return GVL_T10._rTemperaturaInicial; }
            set { GVL_T10._rTemperaturaInicial = value; }
        }
        private static double _rVacuoFinal;// : REAL;
        public static double rVacuoFinal
        {
            get { return GVL_T10._rVacuoFinal; }
            set { GVL_T10._rVacuoFinal = value; }
        }
        public double rForcaMaxima;// : REAL;
        public double rPressaoMaxima;// : REAL;
        public double rDeslocamentoEmPMax;// : REAL;
        ...
        public static double rPressaoInicialCP
        {
            get { return GVL_T10._rPressaoInicialCP; }
            set { GVL_T10._rPressaoInicialCP = value; }
        }
        public static double rPressaoFinalCP
        {
            get { return GVL_T10._rPressaoFinalCP; }
            set { GVL_T10._rPressaoFinalCP = value; }
        }
        private static double _rPressaoInicialCS;// : REAL;
        private static double _rPressaoFinalCS;// : REAL;
        public double rPerdaPressaoCS;// : REAL;
        public static double rPressaoInicialCS
        {
            get { return GVL_T10._rPressaoInicialCS; }
            set { GVL_T10._rPressaoInicialCS = value; }
        }
        public static double rPressaoFinalCS
        {
            get { return GVL_T10._rPressaoFinalCS; }
            set { GVL_T10._rPressaoFinalCS = value; }
        }
    }
    public class GVL_T11
    {
        ...
        public static double rVacuoInicial
        {
            get { return GVL_T11._rVacuoInicial; }
            set { GVL_T11._rVacuoInicial = value; }
        }
        public static double rTemperaturaInicial
        {
            get { return GVL_T11._rTemperaturaInicial; }
            set { GVL_T11._rTemperaturaInicial = value; }
        }
        public int iConsumidoresCP;// : INT;
        public int iConsumidoresCS;// : INT;
        public double rForcaMaxima;// : REAL;
    ...
    public class GVL_T12
    {
        ...
        public static double rVacuoInicial
        {
            get { return GVL_T12._rVacuoInicial; }
            set { GVL_T12._rVacuoInicial = value; }
        }
        public static double rTemperaturaInicial
        {
            get { return GVL_T12._rTemperaturaInicial; }
            set { GVL_T12._rTemperaturaInicial = value; }
        }
        public int iConsumidoresCP;// : INT;
        public int iConsumidoresCS;// : INT;
        public double rForcaMaxima;// : REAL;
    ...
    public class GVL_T13
    {
        ...
        public static double rVacuoInicial
        {
            get { return GVL_T13._rVacuoInicial; }
            set { GVL_T13._rVacuoInicial = value; }
        }
        public static double rTemperaturaInicial
        {
            get { return GVL_T13._rTemperaturaInicial; }
            set { GVL_T13._rTemperaturaInicial = value; }
        }
        public int iConsumidoresCP;// : INT;
        public int iConsumidoresCS;// : INT;
        public double rForcaMaxima;// : REAL;
    ...
    public class GVL_T14
    {
        ...
        public static double rVacuoInicial
        {
            get { return GVL_T14._rVacuoInicial; }
            set { GVL_T14._rVacuoInicial = value; }
        }
        public static double rTemperaturaInicial
        {
            get { return GVL_T14._rTemperaturaInicial; }
            set { GVL_T14._rTemperaturaInicial = value; }
        }
        public int iConsumidoresCP;// : INT;
        public int iConsumidoresCS;// : INT;
        public double rForcaMaxima;// : REAL;
    ...
    public class GVL_T15
    {
        ...
        public static double rVacuoInicial
        {
            get { return GVL_T15._rVacuoInicial; }
            set { GVL_T15._rVacuoInicial = value; }
        }
        public static double rTemperaturaInicial
        {
            get { return GVL_T15._rTemperaturaInicial; }
            set { GVL_T15._rTemperaturaInicial = value; }
        }
        public int iConsumidoresCP;// : INT;
        public int iConsumidoresCS;// : INT;
        public double rForcaMaxima;// : REAL;
    ...
    public class GVL_T16
    {
        ...
        public static double rVacuoInicial
        {
            get { return GVL_T16._rVacuoInicial; }
            set { GVL_T16._rVacuoInicial = value; }
        }
        public static double rTemperaturaInicial
        {
            get { return GVL_T16._rTemperaturaInicial; }
            set { GVL_T16._rTemperaturaInicial = value; }
        }
        public int iConsumidoresCP;// : INT;
        public int iConsumidoresCS;// : INT;
        public double rForcaMaxima;// : REAL;
    ...
    public class GVL_T17
    {
        ...
        public static double rVacuoInicial
        {
            get { return GVL_T17._rVacuoInicial; }
            set { GVL_T17._rVacuoInicial = value; }
        }
        public static double rTemperaturaInicial
        {
            get { return GVL_T17._rTemperaturaInicial; }
            set { GVL_T17._rTemperaturaInicial = value; }
        }
        public int iConsumidoresCP;// : INT;
        public int iConsumidoresCS;// : INT;
        public double rForcaMaxima;// : REAL;
    ...
    public class GVL_T18
    {
        ...
        public static double rVacuoInicial
        {
            get { return GVL_T18._rVacuoInicial; }
            set { GVL_T18._rVacuoInicial = value; }
        }
        public static double rTemperaturaInicial
        {
            get { return GVL_T18._rTemperaturaInicial; }
            set { GVL_T18._rTemperaturaInicial = value; }
        }
        public int iConsumidoresCP;// : INT;
        public int iConsumidoresCS;// : INT;
        public double rForcaMaxima;// : REAL;
    ...
    public class GVL_T19
    {
        ...
        public static double rVacuoInicial
        {
            get { return GVL_T19._rVacuoInicial; }
            set { GVL_T19._rVacuoInicial = value; }
        }
        public static double rTemperaturaInicial
        {
            get { return GVL_T19._rTemperaturaInicial; }
            set { GVL_T19._rTemperaturaInicial = value; }
        }
        public double rForcaMaxima;// : REAL;
        public long diPosicaoForcaMaxima;// : DINT;
        public double rDeslocamentoNaPressao_mm;// : REAL;
    ...
    public class GVL_T20
    {
        ...
        public static double rVacuoInicial
        {
            get { return GVL_T20._rVacuoInicial; }
            set { GVL_T20._rVacuoInicial = value; }
        }
        public static double rTemperaturaInicial
        {
            get { return GVL_T20._rTemperaturaInicial; }
            set { GVL_T20._rTemperaturaInicial = value; }
        }
        public double rForcaMaxima;// : REAL;
        public long diPosicaoForcaMaxima;// : DINT;
        public double rDeslocamentoNaPressao_mm;// : REAL;
    ...
    public class GVL_T21
    {
        ...
        public static double rVacuoInicial
        {
            get { return GVL_T21._rVacuoInicial; }
            set { GVL_T21._rVacuoInicial = value; }
        }
        public static double rTemperaturaInicial
        {
            get { return GVL_T21._rTemperaturaInicial; }
            set { GVL_T21._rTemperaturaInicial = value; }
        }
        public int iConsumidoresCP;// : INT;
        public int iConsumidoresCS;// : INT;
        public long diPosicaoForcaMaxima;// : DINT; //indice do array que indica o pico de forca, tambem indica que o gráfico começou a "voltar" a partir daqui
    ...
    public class GVL_T23
    {
        ...
        public static double rVacuoInicial
        {
            get { return GVL_T23._rVacuoInicial; }
            set { GVL_T23._rVacuoInicial = value; }
        }
        public static double rTemperaturaInicial
        {
            get { return GVL_T23._rTemperaturaInicial; }
            set { GVL_T23._rTemperaturaInicial = value; }
        }
        public int iConsumidoresCP;// : INT;
        public int iConsumidoresCS;// : INT;
        public long diPosicaoForcaMaxima;// : DINT; //indice do array que indica o pico de forca, tambem indica que o gráfico começou a "voltar" a partir daqui
    ...
    public class GVL_T24
    {
        ...
        public static double rVacuoInicial
        {
            get { return GVL_T24._rVacuoInicial; }
            set { GVL_T24._rVacuoInicial = value; }
        }
        public static double rTemperaturaInicial
        {
            get { return GVL_T24._rTemperaturaInicial; }
            set { GVL_T24._rTemperaturaInicial = value; }
        }
