...
namespace Continental.Project.Adam.UI
{
    ...
    public partial class Form_Adam_Main : Form
    {
        ...
        private void subMenu_Project_PrintParamList_Click(object sender, EventArgs e)
        {
            ...
            //GridPrintDocument doc = new GridPrintDocument(TAB_TableResult_Grid, TAB_TableResult_Grid.Font, true);
                ...
                else
                {
                    ...
                    if (!HelperTestBase.ProjectTestConcluded.Project.is_OnLIne)
                    {
                        if (HelperTestBase.ProjectTestConcluded.IdProjectTestConcluded > 0 && HelperTestBase.ProjectTestConcluded.IdProject > 0)
                        {
                            ...
                            {
                                pathWithFileNameHeader = (HelperTestBase.ProjectTestConcluded.Project.PrjTestFileName.Contains(_helperApp.AppTests_DefaultNameData) ? HelperTestBase.ProjectTestConcluded.Project.PrjTestFileName.Replace(_helperApp.AppTests_DefaultNameData, strHeader) : string.Concat(HelperTestBase.ProjectTestConcluded.Project.PrjTestFileName.Replace(_helperApp.AppTests_DefaultExtension, string.Empty), strHeader, _helperApp.AppTests_DefaultExtension));
                                fileNameHeader = string.Concat(pathWithFileNameHeader.Replace(_initialDirPathTestFile, string.Empty).Replace(_helperApp.AppTests_DefaultExtension, string.Empty), _helperApp.AppTests_DefaultExtension);
                            }
                            ...
                            if (_helperApp.CheckFileExists(pathWithFileNameHeader))
                            {
                                if (string.IsNullOrEmpty(fileNameHeader))
                                {
                                    MessageBox.Show("Failed, error fileNameHeader project null !", _helperApp.appMsg_Name, MessageBoxButtons.OK, MessageBoxIcon.Error);
                                    return false;
                                }
                                else
                                {
                                    if (fileNameHeader.Contains(strHeader))
                                        dicReturnReadFileHeader = _helperApp.ReadTXTFileHeaderHBM(fileNameHeader, pathWithFileNameHeader);
                                    else
                                    {
                                        MessageBox.Show("Failed, error fileNameHeader project !", _helperApp.appMsg_Name, MessageBoxButtons.OK, MessageBoxIcon.Error);
                                        return false;
                                    }
                                }
                            }
        ...
        private void rad_EvaluationParameters_CBOutputPC_CheckedChanged(object sender, EventArgs e)
        {
            try
            {
                if (rad_EvaluationParameters_CBOutputPC.Checked)
                {
                    ...
                    if (_helperApp.lstDblReturnReadFile[0] != null && HelperTestBase.ProjectTestConcluded.Project != null)
                    {
                        if (HelperTestBase.ProjectTestConcluded.Project.is_OnLIne)
                        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (TXTFileHBM_LoadData())
                    {
                        ...
                        {
                            if (HelperTestBase.ProjectTestConcluded?.Project?.IdProject > 0)
                            {
        ...
        private bool TEST_Concluded_SaveData()
        {
            try
            {
                ...
                HelperTestBase.ProjectTestConcluded.Project.TestingDate = DateTime.Now.ToString();
        ...
        public void TEST_FileDataConcluded_SetData()
        {
            try
            {
                if (HelperApp.bLoadPrjTestOffLine && HelperTestBase.ProjectTestConcluded.IdProjectTestConcluded > 0 && HelperTestBase.ProjectTestConcluded.IdProject > 0)
                {
        ...
        private bool TXTFileHBM_Create()
        {
            ...
            string testIdentName = string.Empty;
            ...
            else
            {
                ...
                testIdentName = HelperTestBase.ProjectTestConcluded.Project.IdProject > 0 ? HelperTestBase.ProjectTestConcluded.Project.Identification : _helperApp.AppTests_DefaultNameData;

                HelperTestBase.ProjectTestConcluded.TestDateTime = testDate;
                HelperTestBase.ProjectTestConcluded.Project.TestingDate = !string.IsNullOrEmpty(HelperTestBase.ProjectTestConcluded.Project.TestingDate) ? HelperTestBase.ProjectTestConcluded.Project.TestingDate : HelperTestBase.ProjectTestConcluded.TestDateTime;
        ...
        private bool TXTFileHBM_LoadDataConcluded()
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        prjConcluded_FileName = HelperTestBase.ProjectTestConcluded.Project.PrjTestFileName.Replace(_initialDirPathTestFile, "");

                        prjConcluded_PathWithFileName = HelperTestBase.ProjectTestConcluded.Project.PrjTestFileName;
                    }
                }
        ...
        private void HBM_SaveAquisitionTxtData_OLD()
        {
            ...
            try
            {
                ...
                _prjTestFilename = string.Concat(_initialDirPathTestFile, _helperApp.AppTests_DefaultNameData, ".txt");
